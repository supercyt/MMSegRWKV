...
def get_brats_loader_from_train(data_dir, train_rate=0.7, val_rate=0.1, test_rate=0.2, seed=42):
    ...
    base_dir = "/home/caoyitong/DataProjects/inhouse/data2/fullres/train/"
    filter_data_list = ['165.npz', '47.npz', '262.npz', '11.npz', '216.npz', '314.npz', '25.npz', '39.npz', '250.npz',
                        '248.npz', '42.npz', '77.npz', '272.npz', '64.npz', '69.npz', '189.npz', '306.npz', '107.npz',
                        '327.npz', '88.npz', '122.npz', '38.npz', '194.npz', '287.npz', '210.npz', '3.npz', '1.npz',
                        '236.npz', '123.npz', '116.npz', '5.npz', '63.npz', '68.npz', '177.npz', '199.npz', '277.npz',
                        '255.npz', '252.npz', '285.npz', '223.npz', '156.npz', '99.npz', '163.npz', '332.npz',
                        '316.npz', '209.npz', ]
    filter_data_list = [base_dir + each for each in filter_data_list]
    all_paths = list(set(all_paths) - set(filter_data_list))
    ...
    base_dir = "/home/caoyitong/DataProjects/inhouse/data2/fullres/train/"
    filter_test_datalist = ["192", "239", "292", "92", "18", "28", "243", "213", "322", "311"]
    filter_test_datalist = [base_dir + each + ".npz" for each in filter_test_datalist]
    test_datalist = list(set(test_datalist) - set(filter_test_datalist))
    test_datalist = sorted(test_datalist)
